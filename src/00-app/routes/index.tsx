...
// [ Layout ]
const HomeLayout = React.lazy(() => import("@/00-app/routes/layouts/HomeLayout"));
const AppLayout = React.lazy(() => import("@/00-app/routes/layouts/AppLayout"));
const Error400 = React.lazy(() => import("@/01-pages/home/Error400"));
const Error404 = React.lazy(() => import("@/01-pages/home/Error404"));
...
const SignupSelect = React.lazy(() => import("@/01-pages/login/SignupSelect"));
const MentorSignup = React.lazy(() => import("@/01-pages/login/MentorSignup"));
const MenteeSignup = React.lazy(() => import("@/01-pages/login/MenteeSignup"));
const SignupComplete = React.lazy(() => import("@/01-pages/login/SignupComplete"));

const MentosList = React.lazy(() => import("@/01-pages/mentos/MentosList"));
const MentosDetail = React.lazy(() => import("@/01-pages/mentos/MentosDetail"));

const MyMentosList = React.lazy(() => import("@/01-pages/my-profile/MyMentosList"));
const MentorProfile = React.lazy(() => import("@/01-pages/my-profile/MentoProfile"));
const MyProfile = React.lazy(() => import("@/01-pages/my-profile/MyProfile"));

const CreateMentos = React.lazy(() => import("@/01-pages/mentor/CreateMentos"));
const EditMentos = React.lazy(() => import("@/01-pages/mentor/EditMentos"));

const CertificationRegister = React.lazy(() => import("@/01-pages/mentos/CertificationRegister"));
const CertificationPage = React.lazy(() => import("@/01-pages/mentos/CertificationPage"));
const MentoIntroduce = React.lazy(() => import("@/01-pages/login/MentoIntroduce"));
const Reviews = React.lazy(() => import("@/01-pages/mentor/Review"));
const Ready = React.lazy(() => import("@/01-pages/home/Ready"));

const ChatListPage = React.lazy(() => import("@/01-pages/chat/ChatListPage"));
const ChatRoomPage = React.lazy(() => import("@/01-pages/chat/ChatRoomPage"));
const AnalyticsPage = React.lazy(() => import("@/01-pages/chat/AnalyticsPage"));

const MemberReport = React.lazy(() => import("@/01-pages/admin/MemberReport"));
const ReportList = React.lazy(() => import("@/01-pages/admin/ReportList"));

const HomeVideo = React.lazy(() => import("@/01-pages/home/HomeVideo"));
const BookingPage = React.lazy(() => import("@/01-pages/book/Booking"));
const BookingConfirm = React.lazy(() => import("@/01-pages/book/BookingConfirm"));
const MentoIntroduce2 = React.lazy(() => import("@/01-pages/book/MentoIntroduce2"));

// ✅ 새로 추가된 페이지
const PaySuccess = React.lazy(() => import("@/01-pages/book/PaySuccess"));
const MentorMapNearbyPage = React.lazy(() => import("@/01-pages/mentos/MentorMapNearbyPage"));
const CertificationFailPage = React.lazy(() => import("@/01-pages/mentos/CertificationFailPage"));
const ChatBot = React.lazy(() => import("@/01-pages/chat/ChatBot"));
const RecommendPage = React.lazy(() => import("@/01-pages/chat/RecommendPage"));
