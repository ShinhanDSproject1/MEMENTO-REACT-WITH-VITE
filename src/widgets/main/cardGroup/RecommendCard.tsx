...
import AgainIcon from "@assets/icons/icon-again.svg";
import AvatarKogiri from "@assets/images/character/character-kogiri.svg";
import Mentoring1 from "@assets/images/dummy/mentoring1.jpeg";
import Mentoring2 from "@assets/images/dummy/mentoring2.jpeg";
import Mentoring3 from "@assets/images/dummy/mentoring3.jpeg";
...
export interface RecommendItem {
  ...
  mentor: string;
  price: number;
  image?: string; // import된 에셋은 string 경로
  avatar?: string; // 마찬가지
}
  ...
  const fallback: RecommendItem[] = [
    {
      ...
      mentor: "안가연",
      price: 1_000_000,
      image: Mentoring1, // ✅ import 변수 그대로
      avatar: AvatarKogiri, // ✅ import 변수 그대로
    },
    {
      title: "성취란 무엇인가",
      mentor: "김정은",
