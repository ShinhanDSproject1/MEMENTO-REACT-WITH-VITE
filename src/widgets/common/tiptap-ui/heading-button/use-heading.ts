...
// --- Icons ---
import { HeadingFiveIcon } from "@/widgets/common/tiptap-icons/heading-five-icon";
import { HeadingFourIcon } from "@/widgets/common/tiptap-icons/heading-four-icon";
import { HeadingOneIcon } from "@/widgets/common/tiptap-icons/heading-one-icon";
import { HeadingSixIcon } from "@/widgets/common/tiptap-icons/heading-six-icon";
import { HeadingThreeIcon } from "@/widgets/common/tiptap-icons/heading-three-icon";
import { HeadingTwoIcon } from "@/widgets/common/tiptap-icons/heading-two-icon";
