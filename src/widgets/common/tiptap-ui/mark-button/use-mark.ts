...
// --- Icons ---
import { BoldIcon } from "@/widgets/common/tiptap-icons/bold-icon";
import { Code2Icon } from "@/widgets/common/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/widgets/common/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/widgets/common/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/widgets/common/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/widgets/common/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/widgets/common/tiptap-icons/underline-icon";
