...
// --- Icons ---
import { AlignCenterIcon } from "@/03-widgets/common/tiptap-icons/align-center-icon";
import { AlignJustifyIcon } from "@/03-widgets/common/tiptap-icons/align-justify-icon";
import { AlignLeftIcon } from "@/03-widgets/common/tiptap-icons/align-left-icon";
import { AlignRightIcon } from "@/03-widgets/common/tiptap-icons/align-right-icon";
