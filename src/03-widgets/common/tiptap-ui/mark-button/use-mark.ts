...
// --- Icons ---
import { BoldIcon } from "@/03-widgets/common/tiptap-icons/bold-icon";
import { Code2Icon } from "@/03-widgets/common/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/03-widgets/common/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/03-widgets/common/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/03-widgets/common/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/03-widgets/common/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/03-widgets/common/tiptap-icons/underline-icon";
