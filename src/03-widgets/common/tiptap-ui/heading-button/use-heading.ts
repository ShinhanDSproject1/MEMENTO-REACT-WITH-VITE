...
// --- Icons ---
import { HeadingFiveIcon } from "@/03-widgets/common/tiptap-icons/heading-five-icon";
import { HeadingFourIcon } from "@/03-widgets/common/tiptap-icons/heading-four-icon";
import { HeadingOneIcon } from "@/03-widgets/common/tiptap-icons/heading-one-icon";
import { HeadingSixIcon } from "@/03-widgets/common/tiptap-icons/heading-six-icon";
import { HeadingThreeIcon } from "@/03-widgets/common/tiptap-icons/heading-three-icon";
import { HeadingTwoIcon } from "@/03-widgets/common/tiptap-icons/heading-two-icon";
