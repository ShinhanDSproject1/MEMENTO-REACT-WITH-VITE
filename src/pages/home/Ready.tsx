...
function Ready() {
  ...
  return (
    <section className="mx-auto mt-10 text-center">
      <p className="font-WooridaumB text-3xl text-[#23272E]">
        {" "}
        서비스 준비중 입니다
      </p>
      <p className="font-WooridaumB mt-3 text-lg text-[#768297]">
        {" "}
        아쉽지만 다음을 기대해주세요!
      </p>
      <img
        src="../src/shared/assets/images/character-full-dance.svg"
