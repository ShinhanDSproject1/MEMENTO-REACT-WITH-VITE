import character from "@shared/assets/images/character/character-fox.svg";
import logo from "@shared/assets/images/logo/memento-logo.svg";
...
function Error400() {
  ...
  return (
    <section className="mx-auto h-full w-full max-w-100 bg-white text-center">
      ...
      <img src={character} alt="character fox" className="mx-auto mt-20 w-40" />
      <div className="flex-col items-center justify-center">
        <div className="flex items-center justify-center text-8xl">
          <p className="font-bold text-[#00BBA8]">4</p>
